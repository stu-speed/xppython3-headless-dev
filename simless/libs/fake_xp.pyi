...
from XPPython3.xp_typing import (
    XPLMFontID, XPLMCursorStatus, XPLMMenuID, XPLMWindowDecoration,
    XPLMDataRefInfo_t, XPLMFlightLoopID, XPLMFlightLoopPhaseType, XPLMMouseStatus, XPLMWindowID,
    XPLMWindowLayer, XPWidgetClass, XPWidgetID, XPWidgetMessage, XPWidgetPropertyID
)
from simless.libs._flightloop import FlightLoop
from simless.libs.fake_xp_types import (
    DPGOp, EventInfo, FakeDataRef, FakeXPCommandRef, WindowExInfo, XPWidgetCallback
)
...
class FakeXP:
    ...
    def promote_type(self, ref: FakeDataRef, dtype: DRefType, writable: bool, ) -> None: ...
    ...
    def iter_descendants(self, win, root) -> None: ...
    ...
    def getWindowRefCon(self, windowID: XPLMWindowID) -> None: ...
    ...
    def setMenuItemName(self, menuID, index, name) -> None: ...

    def checkMenuItem(self, menuID, index, checked=None) -> None: ...

    def enableMenuItem(self, menuID, index, enabled=1) -> None: ...

    def removeMenuItem(self, menuID, index) -> None: ...
    ...
    def register_windowex(
        self, *, left: int, top: int, right: int, bottom: int, visible: bool, decoration: XPLMWindowDecoration,
        layer: XPLMWindowLayer, draw_cb: Optional[Callable[[XPLMWindowID, Any], None]],
        click_cb: Optional[Callable[[XPLMWindowID, int, int, XPLMMouseStatus, Any], int]],
        right_click_cb: Optional[Callable[[XPLMWindowID, int, int, XPLMMouseStatus, Any], int]],
        ...
        wheel_cb: Optional[Callable[[XPLMWindowID, int, int, int, int, Any], int]], refcon: Any
    ) -> WindowExInfo: ...
    ...
    def bring_window_to_front(self, info: WindowExInfo) -> None: ...
    ...
    def enqueue_dpg(
        self, op: DPGOp, *, target_drawlist: int | None = None, args: tuple[Any, ...] = (),
