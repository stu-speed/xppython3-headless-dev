...
from simless.libs.fake_xp_types import CommandCallback, FakeDataRef, XPWidgetCallback
...
from xp_typing import XPLMCommandPhase, XPLMCommandRef, XPLMCursorStatus, XPLMDataRefInfo_t, XPLMFlightLoopID, \
    XPLMFlightLoopPhaseType, XPLMFontID, XPLMMenuCheck, XPLMMenuID, XPLMMouseStatus, XPLMPluginID, XPWidgetClass, \
...
class FakeXP:
    ...
    def registerDataAccessor(self, name: str, *, dataType: int = 0, writable: int = -1,
                             ...
                             readRefCon: Optional[Any] = None, writeRefCon: Optional[Any] = None, ) -> FakeDataRef: ...
    ...
    def appendMenuItemWithCommand(self, menuID: Optional[XPLMMenuID] = None, name: str = "Command",
    ...
    def sendMessageToWidget(self, wid: XPWidgetID, msg: XPWidgetMessage, param1: Any, param2: Any, ) -> None: ...

    def broadcastMessageToWidget(self, wid: XPWidgetID, msg: XPWidgetMessage, param1: Any, param2: Any, ) -> None: ...
