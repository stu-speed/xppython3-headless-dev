...
from XPPython3.xp_typing import (
    XPLMCursorStatus, XPLMFontID, XPLMWindowDecoration, XPLMDataRefInfo_t, XPLMFlightLoopID, XPLMFlightLoopPhaseType, XPLMMenuID,
    XPLMMouseStatus, XPLMWindowID, XPLMWindowLayer, XPWidgetClass, XPWidgetID, XPWidgetMessage, XPWidgetPropertyID
)
from simless.libs._flightloop import FlightLoop
from simless.libs.fake_xp_types import (
    DPGOp, EventInfo, FakeDataRef,
    FakeXPCommandRef,
    XPWidgetCallback
)
...
class FakeXP:
    ...
    def enqueue_dpg(
        self, op: DPGOp, *, target_drawlist: str | None = None, args: tuple[Any, ...] = (),
