...
class FakeXP:
    ...
    def getDatavi(self, dr: XPLMDataRef, out: Optional[List[int]], offset: int, count: int, ) -> int: ...

    def getDatavf(self, dr: XPLMDataRef, out: Optional[List[float]], offset: int, count: int, ) -> int: ...

    def getDatabv(self, dr: XPLMDataRef, out: Optional[List[int]], offset: int, count: int, ) -> int: ...

    def getDatas(self, dr: XPLMDataRef, out: Optional[List[int]] = None, offset: int = 0, count: int = -1, ) -> int: ...
    ...
    def setDatavi(self, dr: XPLMDataRef, values: Sequence[int], offset: int, count: int, ) -> None: ...

    def setDatavf(self, dr: XPLMDataRef, values: Sequence[float], offset: int, count: int, ) -> None: ...

    def setDatabv(self, dr: XPLMDataRef, values: Sequence[int], offset: int, count: int, ) -> None: ...

    def setDatas(self, dr: XPLMDataRef, values: Sequence[int], offset: int = 0,
