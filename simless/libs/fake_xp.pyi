...
from XPPython3.xp_typing import (
    XPLMFontID, XPLMCursorStatus, XPLMWindowDecoration, XPLMDataRefInfo_t, XPLMMenuID, XPLMMouseStatus, XPLMWindowID, XPLMWindowLayer,
    XPWidgetClass, XPWidgetID, XPWidgetMessage, XPWidgetPropertyID
)
from simless.libs.fake_xp_types import (
    DPGOp, EventInfo, EventKind, FakeDataRef, FlightLoopStruct, WindowExInfo, XPWidgetCallback
)
...
class FakeXP:
    ...
    def from_xp(
        self, cls, *, kind: EventKind, xp_x: Optional[int] = None, xp_y: Optional[int] = None,
        **kwargs, ) -> "EventInfo": ...

    def from_dpg(
        self, cls, *, kind: EventKind, dpg_x: int, dpg_y: int, dpg_vp_height: int, **kwargs, ) -> "EventInfo": ...
    ...
    def createFlightLoop(self, struct: FlightLoopStruct | Callable[..., float], refcon: Any = None, ) -> int: ...
